...
const ResumePage = () => {
  ...
  // Update template when selected but preserve other data 
  useEffect(() => {
  ...
  const handleUpdateResumeData = (data: ResumeData) => {
    setResumeData(prevData => ({
      ...data,
      template: selectedTemplate // Keep the selected template
    }));
  };
            ...
            <div className="lg:max-h-[calc(100vh-160px)] overflow-y-auto pr-4">
              <Tabs defaultValue="content" value={activeTab} onValueChange={setActiveTab}>
                ...
                <TabsContent value="content" className="space-y-4">
                  <ResumeForm setResumeData={handleUpdateResumeData} resumeData={resumeData} />
                </TabsContent>
