    ...
    <div className="font-serif p-6 max-w-[800px] mx-auto text-[10px] print:text-[9pt] text-black bg-white border-2 border-gray-200 shadow-lg">
      <div className="text-left mb-4">
        ...
        <div className="mb-4">
          ...
          <div className="mt-4">
            <h3 className="text-[12px] font-semibold text-gray-700 mb-2">Recipient Information:</h3>
        ...
        <div className="mb-6">
          <h3 className="text-[12px] font-semibold text-gray-700 mb-2">Dear {data.recipientInfo.name || 'Hiring Manager'},</h3>
        ...
        <div className="mt-4">
          <p className="mb-2 text-[10px] font-semibold">Sincerely,</p>
